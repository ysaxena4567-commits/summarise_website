      ...
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-6xl flex-col items-center justify-center gap-8">
        ...
        <section className="w-full max-w-md rounded-2xl border border-[#c5b358]/30 bg-[#101012]/80 p-3 shadow-2xl shadow-black/35">
          <div className="px-3 pb-4 pt-2 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#c5b358]">Secure Login</p>
            <h1 className="mt-2 text-3xl font-semibold text-white">Sign in to JustFlamsit</h1>
            <p className="mt-2 text-sm leading-6 text-[#f2e7a5]">Continue with email or Google to manage your summaries.</p>
          </div>
          <SignIn
